...
+ Implementación del lado del cliente {#client-side}
   ...
   + Implementación de Adobe Experience Platform Web SDK {#aep}
      ...
      + [Uso de Adobe Target y Platform Web SDK para la personalización](/help/dev/implement/client-side/aep-web-sdk/target-overview.md)
      + [Implementación de aplicación de una sola página](/help/dev/implement/client-side/aep-web-sdk/spa-implementation.md)
      + [Acceso a tokens de respuesta](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [Uso del ID de terceros de mbox](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
      + [Comparación de la biblioteca at.js con Web SDK](/help/dev/implement/client-side/aep-web-sdk/web-sdk-atjs-comparison.md)
