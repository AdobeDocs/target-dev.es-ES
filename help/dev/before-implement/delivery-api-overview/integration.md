...
Para obtener información acerca de la integración del lado del servidor con [!DNL Experience Cloud ID (ECID) Service], vea [Servicio Experience Cloud ID (ECID)](/help/dev/implement/server-side/sdk-guides/integration-with-experience-cloud/ecid.md).
