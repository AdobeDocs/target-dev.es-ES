...
description: Obtenga información acerca de los procedimientos que utiliza Adobe para reforzar la seguridad de sus datos y de la experiencia  [!DNL Adobe Target] de.
...
Para obtener más información, consulte el documento técnico [Información general sobre la seguridad de Adobe Target](https://www.adobe.com/cc-shared/assets/pdf/trust-center/ungated/whitepapers/experience-cloud/adobe-target-security-overview.pdf).
