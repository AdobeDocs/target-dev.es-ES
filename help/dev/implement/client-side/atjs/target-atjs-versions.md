...
description: Vea los detalles sobre los cambios realizados en cada versión de la biblioteca JavaScript at.js [!DNL Adobe Target].
...
## Versión 2.11.9 de at.js (febrero de 2026)

* Se ha resuelto un problema en el cual la función applyOffers de at.js no detectaba ni modificaba correctamente Lightning Web Components (LWC). La biblioteca at.js se ha actualizado para detectar componentes LWC y aplicar modificaciones según corresponda. (TGT-54478)
...
* [!UICONTROL Los detalles de las métricas de clic de Analytics for Target] (A4T) se devuelven correctamente al usar `prefetch` solicitudes.
...
* **Registro de análisis del lado del cliente**: Proporcione a los clientes control total sobre cómo desean enviar datos de análisis a [!DNL Adobe Analytics], ya sea en el lado del cliente o en el lado del servidor.
  ...
  Para obtener más información, consulte [Registro del lado del cliente [!DNL Analytics] 2&rbrace;.](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/before-implement.html#client-side)
...
* Se ha corregido un problema en la configuración de la actividad [!UICONTROL Segmentación de experiencias] que fallaba dentro del VEC al cambiar entre Examinar y Componer. (TNT-27942)
