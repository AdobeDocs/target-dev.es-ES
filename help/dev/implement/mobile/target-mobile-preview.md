...
1. En la interfaz de usuario [!DNL Target], haga clic en el icono **[!UICONTROL Más opciones]** (los puntos suspensivos verticales) y, a continuación, seleccione **[!UICONTROL Crear vínculo de vista previa para móviles]**.

   ![imagen alt](assets/mobile-preview-create.png)

1. Seleccione las actividades que quiera previsualizar y luego haga clic en **[!UICONTROL Generar vínculo de vista previa para móviles]**.

   >[!NOTE]
   >
   >Solo puede seleccionar actividades de [!UICONTROL Prueba A/B] y [!UICONTROL Segmentación de experiencias] (XT) basadas en formularios.
...
1. Abra el vínculo en su navegador móvil.
   ...
   Su aplicación se abre e inicia el [!DNL Target] [!UICONTROL Modo de vista previa para móviles].
...
* Debe volver a cargarse la vista para que el nuevo contenido se muestre después de hacer clic en el botón **[!UICONTROL Iniciar experiencias]**. El modo más sencillo es cambiar a una pantalla diferente y regresar a aquella en la que espera que se produzca el cambio.
