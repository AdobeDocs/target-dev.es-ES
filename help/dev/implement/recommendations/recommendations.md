...
Para tener acceso a las opciones de **[!UICONTROL Configuración de Recomendaciones]**, abra Target en [!DNL Adobe Experience Cloud] y, a continuación, haga clic en **[!UICONTROL Recomendaciones]** > **[!UICONTROL Configuración]**.

![imagen alt](assets/recs_settings.png)

Las opciones disponibles son las siguientes:

| Configuración | Descripción |
|--- |--- |
| Mbox global personalizado | (Opcional) Especifique el mbox global personalizado que se usa para aprovisionar actividades de [!UICONTROL Target]. De manera predeterminada, el mbox global utilizado por [!UICONTROL Target] se usa para [!UICONTROL Recomendaciones].<P>Nota: Esta opción se configura en la variable [!UICONTROL Target] **[!UICONTROL Administration]** página. Abrir [!UICONTROL Target], luego haga clic en **[!UICONTROL Administration]** > **[!UICONTROL Compositor de experiencias visuales]**. |
...
| [!UICONTROL Token de API de Recommendations] | Utilice este token en [!UICONTROL Recommendations] Llamadas a la API, como la API de descarga. |
