...
description: Obtenga información sobre cómo instalar  [!DNL Adobe Target] .NET SDK.
feature: APIs/SDKs
...
[NuGet](https://www.nuget.org/packages/Adobe.Target.Client) distribuye .NET SDK. Para empezar, agréguela como una dependencia mediante la instalación mediante `Package Manage` o `.NET CLI`:
