---
title: Cómo usar solicitudes asincrónicas en el SDK  [!DNL Adobe Target] Node.js
description: Descubra cómo  [!DNL Target] Node.js SDK admite solicitudes asincrónicas, lo que puede reducir el tiempo de destino efectivo a cero.
feature: APIs/SDKs
