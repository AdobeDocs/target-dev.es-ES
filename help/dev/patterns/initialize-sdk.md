...
description: Asegúrese de que todos los pasos necesarios para cargar el SDK web de Adobe Experience Platform se ejecutan en la secuencia correcta.
feature: APIs/SDKs
level: Experienced
role: Developer
hide: true
...
![Inicializar diagrama de SDK](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![Cargar diagrama del SDK de API de visitante](/help/dev/patterns/assets/load-visitor-api-sdk.png){width="100" zoomable="yes"}
...
* Necesita el `VisitorAPI.js` archivo. Póngase en contacto con su equipo de marketing digital para obtener este archivo.
...
![Establecimiento del ID de cliente](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![Configurar la solicitud automática de carga de página](/help/dev/patterns/assets/configure-automatic-page-request.png){width="100" zoomable="yes"}
...
![Configurar diagrama de control de parpadeo](/help/dev/patterns/assets/flicker-handling.png){width="100" zoomable="yes"}
...
![Diagrama de asignación de datos](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![Diagrama de asignación de datos remotos](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
...
![Cargar diagrama de SDK web de Adobe Target](/help/dev/patterns/assets/load-web-sdk.png){width="100" zoomable="yes"}

**Requisitos previos**

* Descargue o pida a su equipo de marketing digital el archivo de biblioteca del SDK web: `at.js 2.*x*`
