...
![Activar diagrama de solicitud de carga de página](/help/dev/patterns/recs-atjs/assets/fire-page-load-request.png){width="400" zoomable="yes"}
...
![Activar diagrama de solicitud de ubicación regional](/help/dev/patterns/recs-atjs/assets/fire-regional-location-request.png){width="400" zoomable="yes"}
